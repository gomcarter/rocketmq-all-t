...
public class TransactionDispatchService extends ServiceThread {
    ...
    private void doDispatch() {
        ...
        Set<String> producerGroupSet = producerToRequestMapRead.keySet();
        List<CompletableFuture<Void>> futures = new ArrayList<>(producerGroupSet.size());
        long transactionTimestamp = 0;
        for (String producerGroup : producerGroupSet) {
